...
export function EditDialog({ open, setOpen }: { open: boolean; setOpen: any }) {
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            Editar {isSubCategory ? "Subcentro de custo" : "Centro de custo"}
          </DialogTitle>
          <DialogDescription>
        ...
        <div className="flex flex-col gap-4">
          <div>
            <Label htmlFor="name">
              Nome da {isSubCategory ? "subcentro de custo" : "centro de custo"}
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="is-sub-category">É um subcentro de custo</Label>
          </div>
    ...
    <Dialog open={open} onOpenChange={(v) => setOpen(v)}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <p className="text-sm text-gray-600">
          Selecione uma cor abaixo para identificar sua centro de custo.
        </p>
    ...
    <Select>
      <SelectTrigger className="w-80 mt-2">
        <div className="flex gap-2 items-center">
          <SelectValue
            className="w-80"
            placeholder="Selecione uma centro de custo"
          />
        </div>
      </SelectTrigger>
      <SelectContent>
